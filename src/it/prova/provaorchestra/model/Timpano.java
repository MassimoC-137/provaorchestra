...
public class Timpano extends Strumento {

	public Timpano() {
	}

	public Timpano(String nome, int estensione, Famiglia famiglia, boolean accordabile, boolean accordato) {
	...
	public String produciSuono() {
		if (isAccordato()) {
			return "Suono il timpano: DOOM DOOM";
		} else {
